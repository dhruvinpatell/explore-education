<%@ Page Language="C#" AutoEventWireup="true" codeFile="feedback.aspx.cs" Inherits="Expand_Education.feedback" %>
...
<div class="content">
  ..
    ...
    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:GridView ID="GridView1" runat="server" Height="297px" 
        style="margin-left: 254px" Width="524px" AutoGenerateDeleteButton="True" 
