...
{
    public partial class Compoundwordsq1g : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (RadioButtonList1.SelectedIndex == 0 || RadioButtonList1.SelectedIndex == 2 || RadioButtonList1.SelectedIndex == 1)
            {
            ...
            if (RadioButtonList2.SelectedIndex == 1 || RadioButtonList2.SelectedIndex == 2 || RadioButtonList2.SelectedIndex == 3)
            {
            ...
            if (RadioButtonList3.SelectedIndex == 3 || RadioButtonList3.SelectedIndex == 2 || RadioButtonList3.SelectedIndex == 1)
            {
