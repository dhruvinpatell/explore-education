    ...
    <center><h1>Login</h1></center>
       ...
       <br /><center>
           ...
           <asp:TextBox ID="TextBox1" runat="server" Font-Size="Medium" 
                   style="margin-left: 21px" Width="271px"></asp:TextBox>
               <br />
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           ...
           <asp:TextBox ID="TextBox2" runat="server" Font-Size="Medium" 
                   style="margin-left: 21px" Width="271px" TextMode="Password"></asp:TextBox>
               <br />
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               ...
               <asp:Button ID="Button1" runat="server" BackColor="#00CC00" Font-Bold="True" 
                   Font-Size="Medium" Height="38px"  Text="Login" 
                   Width="137px" onclick="Button1_Click" style="margin-left: 0px"  />
               &nbsp;&nbsp;&nbsp;
               <asp:Button ID="Button2" runat="server" BackColor="#FF3300" Font-Bold="True" 
                   Font-Size="Medium" Height="38px"  Text="Cancle" 
                   Width="137px" style="margin-left: 0px" />
               <br />
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           </center>
        </asp:Panel>
