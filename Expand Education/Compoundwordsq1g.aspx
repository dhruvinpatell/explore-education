<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Compoundwordsq1g.aspx.cs" Inherits="Expand_Education.Compoundwordsq1g" %>
...
<body>
    ...
    <div>
     <center><h1>Compound Words Quize</h1></center>
        <asp:Label ID="Label1" runat="server" Text="1) Choose the suffix for the given word to form a new word.
color
.
"></asp:Label>
...
&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <br />
          <asp:Label ID="Label2" runat="server" Text="2) Choose the suffix for the given word to form a new word.
cheer"></asp:Label>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <br />
          <asp:Label ID="Label3" runat="server" Text="3) Choose the suffix for the given word to form a new word.
spot"></asp:Label>
...
&nbsp;&nbsp;&nbsp;&nbsp;<asp:RadioButtonList ID="RadioButtonList3" runat="server" Height="126px" 
        ...
        <br />
        <br />
           <asp:Label ID="Label4" runat="server" Text="4) Choose the suffix for the given word to form a new word.
end"></asp:Label>
        <br />
&nbsp;&nbsp;&nbsp;
