<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Loginforteacher.aspx.cs" Inherits="Expand_Education.Loginforteacher" %>
...
<body>
    ...
    <center><h1>Login</h1></center>
       ...
       <asp:Panel ID="Panel1" runat="server" CssClass="login-panel">
           ...
           <asp:LinkButton ID="LinkButton1" runat="server" CssClass="forgot-link" Font-Size="Medium" onclick="LinkButton1_Click">Forgot Password</asp:LinkButton>
