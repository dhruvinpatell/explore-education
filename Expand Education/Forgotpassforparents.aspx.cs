...
{
    public partial class Forgotpassforparents : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
                  try
            {
                ...
                con.Open();
                OleDbCommand cmd = new OleDbCommand("Select *from Parents_Account_Information where Username='" + TextBox1.Text + "'", con);
