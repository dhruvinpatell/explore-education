...
{
    public partial class SecurityqSignup : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
                   ...
                   try
            {
                ...
                cmd.CommandText = "Insert Into Parents_Security_Question([Question],[Answer])VALUES('" + DropDownList1.SelectedValue+ "','" + TextBox1.Text + "')";
                cmd.Connection = con;
                cmd.ExecuteNonQuery();
