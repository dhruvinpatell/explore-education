...
<body>
    ...
    <center><h1>Login</h1></center>
       ...
       <asp:Panel ID="Panel1" runat="server" CssClass="login-panel">
           ...
           <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox1" ErrorMessage="Please Enter Password" ForeColor="Red"></asp:RequiredFieldValidator>
           ...
           <asp:LinkButton ID="LinkButton1" runat="server" CssClass="forgot-link" Font-Size="Medium" onclick="LinkButton1_Click" Font-Bold="False">Forgot Password</asp:LinkButton>
           ...
           <asp:Button ID="Button2" runat="server" CssClass="aspNetButton" BackColor="#FF3300" Font-Bold="True" Font-Size="Medium" Height="38px" Text="Cancle" Width="137px" onclick="Button2_Click" />
       </asp:Panel>
        <p>
        </p>
    </form>
