<%@ Page Language="C#" AutoEventWireup="true" codeFile="parentsalltable.aspx.cs" Inherits="Expand_Education.parentsalltable" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:GridView ID="GridView1" runat="server" AutoGenerateDeleteButton="True" 
        AutoGenerateEditButton="True" Height="202px" 
  
       Width="761px" BorderWidth="2px" style="margin-left: 23px">
        <EmptyDataRowStyle BackColor="#FFFF66" BorderStyle="Groove" />
    </asp:GridView>
